        ...
        this.game.enemies.forEach(enemy => {
            if(
                ...
                if (this.currentState === this.states[4] || this.currentState === this.states[5]){
                    ...
                    if (this.game.time <= 5000) this.game.time += this.timeFull;
                    else this.game.time = this.timeFull * 2;
                    //Para aumentar vidas
                    if (this.game.score === 100) {
                        this.game.lives++;
                        if (this.game.lives >= 5) this.game.lives = 5;
                    } 
                    //Mensaje flotante
                    ...
                    this.game.time -= this.timeReduce;
                    if (this.game.time < 0) this.game.time = 0;
                    //Disminuir vidas;
                    this.game.lives--;
